(function() {
        ...
        try {
            currentAdRequestId = generateAdSessionId();
              ...
              const mockResponse = {
                AdInfo: {
                    ad_id: "test_ad_123",
                    ad_creative_url: "https://dev-creativestore-an.hydro.online/campaign-beta-1.png",
    ...
    function displayBanner() {
        ...
        for (let i = 0; i < totalImages; i++) {
            // Create container for each content block
            ...
            Object.assign(topSection.style, {
                height: '80px', // Half of total height
                width: '113%',
                position: 'relative'
            });
            // Create image container (50% width)
            const imgContainer = document.createElement('div');
            Object.assign(imgContainer.style, {
                position: 'absolute',
                top: '0',
                right: '0',
                width: '1000px', // Half of total width
                height: '80px', // Half of total height
                overflow: 'visible',
                cursor: 'pointer',
                borderRadius: '14px',
        ...
        // Create bottom section for additional text
        const bottomSection = document.createElement('div');
        Object.assign(bottomSection.style, {
            height: '60px', // Half of total height
            width: '30%',
            padding: '15px',
            paddingBottom: '0px',
            marginLeft: '40px',
...
Object.assign(imageTextContainer.style, {
    width: '50%',
    padding: '5px',
    marginTop: '0px', // Position below the image
    textAlign: 'left',
    color: 'black',
    fontSize: '12px'
});
imageTextContainer.innerHTML = `<p style="margin: 0 0 0 0; font-size: 12px; color: black; opacity: 0.35">To enhance your browsing experience and help support this website, we use Hydro's Web3 technology for monetization. </p>
<p style="margin: 0 0 0 0; font-size: 12px; color: black; opacity: 0.35">This allows the site to generate revenue for the content that is created daily and support the publisher.</p>`;
            // Add your text content here
    topTextContainer.innerHTML = `
                <p style="margin: 0 0 0 0; font-size: 12px; color: black">By continuing to use this site, youy agree to the use of Hydro's monetization solution.</p>
                <p style="margin: 0; font-size: 12px; color: black"> You can close this banner by clicking this Ad section.</p>
...
const response = await fetch(config.eventURl + '/api/v1/ad-click', {
    ...
    function startScrolling(element, singleImageWidth) {
        ...
        const speed = 0; // pixels per millisecond
